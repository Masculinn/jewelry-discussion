         ...
         <meta name="description" content={post.body.substring(0,140).trim()} />
            ...
            <div className="column is-2">
                <div className="is-flex-mobile">
                    ...
                    <p className='mr-1'><small> <a href={'/user/' + post.owner.username} className='has-text-dark'>@{post.owner.username} </a>
                                    posted <ReactTimeago date={post.created_at} /></small></p>
                    <p> <a href={'/posts/tag/' + post.tag} className='tag is-link is-light'>{post.tag}</a></p>
                </div>

                {owner &&
                    <div className='mt-2'>
                         <a href={'/posts/create?post=' + post.slug}> Edit </a>&nbsp;
